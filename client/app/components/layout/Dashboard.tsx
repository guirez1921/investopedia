...
import { CurrencyExchange } from '../currencies/CurrencyExchange';
import { NewsCard } from '../news/NewsCard';
import { StatsCard } from '../ui/StatsCard';
import { BarChart3, TrendingDown, TrendingUp, Wallet2 } from 'lucide-react';
import { getCrypto, getCurrencyPair, getMarketIndex, getNews, getStock } from '~/utils/getStocks';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // const secondNews = await getNews();
        // const crypto = await getCrypto();
        // const marketIndex = await getMarketIndex('S&P 500');
        const stock = await getStock('AAPL');
        // const currencyPair = await getCurrencyPair('EUR', 'USD');
        // console.log('Fetched Crypto:', crypto);
        // console.log('Fetched News:', news);
        // console.log('Fetched Second News:', secondNews);
        // console.log('Fetched Market Index:', marketIndex);
        console.log('Fetched Stock:', stock);
        // console.log('Fetched Currency Pair:', currencyPair);
      } catch (error) {
